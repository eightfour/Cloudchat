    ...
    socket.on('chat message', function(data){
        ...
        .then((response) => { 
            ...
            if((data.msg.charAt(0) ==  '\\') && (data.msg.charAt(1) == 'p') && (data.msg.charAt(2) == ' ')){
                ...
                if(id != ''){
                    io.to(id).emit('chat message3', {username: socket.username, message: messagepriv, color: coloru, media: data, textcolor: textcolor});
                    io.to(socket.id).emit('chat message4', {username: usernamepriv, message: messagepriv, color: coloru, media: data, textcolor: textcolor});
                }else {
                }
